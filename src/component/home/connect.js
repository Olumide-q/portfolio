       ...
       <div className="w-full text-white">
                   ...
                   <div className=" ">
                       ...
                       <div className="flex gap-4 pt-[40px] pb-[64px] lg:pb-[290px]">
                           <Image className="rounded-xl cursor-not-allowed"  alt="Logo" src={linkdeln} />
                           <Image className="rounded-xl  cursor-not-allowed"  alt="Logo" src={github} />
                           <Image className="rounded-xl  cursor-not-allowed"  alt="Logo" src={twitter} />
                           <Image className="rounded-xl  cursor-not-allowed"  alt="Logo" src={insta} />
                       </div>
